                ...
                <div className="accordion-body p-0">
                  <div className="p-3">
                    ...
                    <p>
                      ...
                      properties in Gurgaon as it has 4 restaurants/1000 people.
                      City Average is 3 restaurants/1000 people.
                    </p>
                    <p>
                      There are{" "}
                      <span className="label label-danger">60 Restaurants</span>{" "}
                      in the location that can compete with you for the same
                      customers.
                    </p>
                    <p>
                      This location has{" "}
                      <span className="label label-success">20 big brands</span>{" "}
                      that can compete with your business. Big brands generally
                  ...
                  <div className="p-3 bg-light-blue overflow-hidden">
                    <div className="mb-3">
                      <h3 className="h5">
                        <strong>Compare with Similar Properties basis:</strong>
                      </h3>
                    </div>
                            ...
                            <td>
                              <div className="row m-0 pro-address ">
                                <div className="col-7 p-0">
                                  ...
                                  <p className="small text-light">Sector 10</p>
                                </div>
                ...
                <div className="accordion-body p-0">
                  <div className="p-3">
                    ...
                    <p>
                      ...
                      as compared to a city average of 750 people (50 m radius)
                    </p>
                    <p>
                  ...
                  <div className="p-3">
                    ...
                    <div className="mb-3">
                      ...
                      <p>
                        ...
                        available which is{" "}
                        <span className="label label-success">higher</span> than
                        city average.
                      </p>
                      <p>
        ...
        <div className="container">
          <ul className="details-list icon-list">
            ...
            <li>
              ...
              Address: GF, Flat No- 287, Shaheed Bhagat Singh Apartments, Sector
              14 Pocket 3, Dwarka, New Delhi 110075, Delhi Dwarka
            </li>
          </ul>
          {/* MAP START */}
          ...
          <div className="mb-3">
            ...
            <ul className="details-list icon-list">
              ...
              <li>
                <img src="assets/images/wheelchair-accessibility.svg" alt="" />
